package com.carbontest.APIServer.DSconfig;
...
public class CarbonDataSourceConfig {
    ...
    static final String PACKAGE = "com.carbontest.APIServer.dao.carbon";
    static final String MAPPER_LOCATION = "classpath:mapper/carbon/*.xml";


    //@Value 获取全局配置文件 application.properties 的 kv 配置,并自动装配
    @Value("${carbon.datasource.url}")
    private String url;

    @Value("${carbon.datasource.username}")
    private String user;

    @Value("${carbon.datasource.password}")
    private String password;

    @Value("${carbon.datasource.driverClassName}")
